...
variable "autounattend" {
  type    = string
  default = "./answer_files/11_23h2_eval_kubevirt/Autounattend.xml"
}
...
variable "iso_url" {
  type    = string
  default = "./iso/Windows_11_23H2_EnterpriseEval_x64.iso"
}
...
variable "vm_name" {
  type    = string
  default = "windows_11_23h2_eval_kubevirt"
}
...
source "qemu" "win11_23h2_eval_kubevirt" {
  iso_url      = var.iso_url
  ...
  floppy_files = [
    ...
    "./scripts/70-install-misc-kubevirt.bat",
...
build {
  sources = ["source.qemu.win11_23h2_eval_kubevirt"]

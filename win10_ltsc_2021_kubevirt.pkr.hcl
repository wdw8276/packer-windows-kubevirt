...
variable "autounattend" {
  type    = string
  default = "./answer_files/10_ltsc_2021_kubevirt/Autounattend.xml"
}
...
variable "iso_url" {
  type    = string
  default = "./iso/en-us_windows_10_enterprise_ltsc_2021_x64_dvd_d289cf96.iso"
}
...
variable "vm_name" {
  type    = string
  default = "windows_10_ltsc_2021_kubevirt"
}
...
source "qemu" "win10_ltsc_2021_kubevirt" {
  iso_url      = var.iso_url
  ...
  floppy_files = [
    ...
    "./scripts/0-firstlogin-kubevirt-win10.bat",
...
build {
  sources = ["source.qemu.win10_ltsc_2021_kubevirt"]
  ...
  provisioner "powershell" {
    scripts           = ["./scripts/init-kubevirt-win10.ps1"]

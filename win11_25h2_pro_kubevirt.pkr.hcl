...
variable "autounattend" {
  type    = string
  default = "./answer_files/11_25h2_pro_kubevirt/Autounattend.xml"
}
...
variable "iso_url" {
  type    = string
  default = "./iso/Win11_25H2_English_x64_v2.iso"
}
...
variable "vm_name" {
  type    = string
  default = "windows_11_25h2_pro_kubevirt"
}
...
source "qemu" "win11_25h2_pro_kubevirt" {
  iso_url      = var.iso_url
...
build {
  sources = ["source.qemu.win11_25h2_pro_kubevirt"]

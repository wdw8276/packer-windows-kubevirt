...
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\NetKVM\netkvm.inf'
Copy-Item -Path 'E:\drivers\amd64\2k22\NetKVM\netkvmp.exe' -Destination 'C:\Windows\System32\netkvmp.exe'
Copy-Item -Path 'E:\drivers\amd64\2k22\NetKVM\netkvmco.exe' -Destination 'C:\Windows\System32\netkvmco.exe'
Start-Sleep -Seconds 20

Write-Host "Install vioscsi"
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\vioscsi\vioscsi.inf'
Start-Sleep -Seconds 20

Write-Host "Install vioserial"
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\vioserial\vioser.inf'
Start-Sleep -Seconds 20

Write-Host "Install viostor"
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\viostor\viostor.inf'
Start-Sleep -Seconds 20

Write-Host "Install viorng"
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\viorng\viorng.inf'
Start-Sleep -Seconds 20

Write-Host "Install blnsvr (Balloon)"
PnPutil.exe /add-driver 'E:\drivers\amd64\2k22\Balloon\balloon.inf'
New-Item -Path 'C:\Program Files\Balloon' -ItemType Directory -Force
Copy-Item -Path 'E:\drivers\amd64\2k22\Balloon\blnsvr.exe' -Destination 'C:\Program Files\Balloon\blnsvr.exe'
...
PnPutil.exe -i -a 'E:\drivers\amd64\2k22\viofs\viofs.inf'
New-Item -Path 'C:\Program Files\viofs' -ItemType Directory -Force
Copy-Item -Path 'E:\drivers\amd64\2k22\viofs\virtiofs.exe' -Destination 'C:\Program Files\viofs\virtiofs.exe'
Start-Sleep -Seconds 20

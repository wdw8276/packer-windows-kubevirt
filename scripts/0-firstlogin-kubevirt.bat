...
REM Install chocolatey - handled in provisioner stage (70-install-misc.bat) where E:\ is available
REM powershell -NoProfile -InputFormat None -ExecutionPolicy Bypass -Command "$env:ChocolateyDownloadUrl='file:///E:/chocolatey.nupkg'; iex (Get-Content 'A:\install-choco.ps1' -Raw)"

...
variable "autounattend" {
  type    = string
  default = "./answer_files/10_ltsc_2019_kubevirt/Autounattend.xml"
}
...
variable "iso_url" {
  type    = string
  default = "./iso/en_windows_10_enterprise_ltsc_2019_x64_dvd_5795bb03.iso"
}
...
variable "vm_name" {
  type    = string
  default = "windows_10_ltsc_2019_kubevirt"
}
...
source "qemu" "win10_ltsc_2019_kubevirt" {
  iso_url      = var.iso_url
...
build {
  sources = ["source.qemu.win10_ltsc_2019_kubevirt"]
